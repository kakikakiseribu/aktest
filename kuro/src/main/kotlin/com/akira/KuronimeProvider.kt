...
class KuronimeProvider : MainAPI() {
    ...
    companion object {
        const val KEY = "3&!Z0M,VIZ;dZW==" //3&!dZWZ0M,== key opsional
        ...
        runAllAsync(
            {
                val decrypt = AesHelper.cryptoAESHandler(
                    base64Decode(servers?.src ?: return@runAllAsync),  // // Mengambil teks "eyJjdCI6..."
                    KEY.toByteArray(), // // Menggunakan kunci "3&!Z0M,VIZ;dZW=="
                    false,
                    "AES/CBC/NoPadding"  // // Algoritma yang digunakan
                )
                val source =
